                ...
                <div class="col-lg-8 mx-auto">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title mb-0">Edit Settings</h4>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="primary_mobile_no" class="form-control @error('primary_mobile_no') is-invalid @enderror"
                                            value="{{ old('primary_mobile_no', $setting->primary_mobile_no) }}" required>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="secondary_mobile_no" class="form-control @error('secondary_mobile_no') is-invalid @enderror"
                                            value="{{ old('secondary_mobile_no', $setting->secondary_mobile_no) }}">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="email" name="primary_email" class="form-control @error('primary_email') is-invalid @enderror"
                                            value="{{ old('primary_email', $setting->primary_email) }}" required>
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <textarea name="address" class="form-control @error('address') is-invalid @enderror" rows="2" required>{{ old('address', $setting->address) }}</textarea>
                                        @error('address')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                    </div>

                                    <div class="col-md-12 mb-3">
                                        <label class="form-label">Embedded Map</label>
                                        <textarea name="embedded_map" class="form-control @error('embedded_map') is-invalid @enderror" rows="3" required>{{ old('embedded_map', $setting->embedded_map) }}</textarea>
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" name="footer_text" class="form-control @error('footer_text') is-invalid @enderror"
                                            value="{{ old('footer_text', $setting->footer_text) }}" required>
