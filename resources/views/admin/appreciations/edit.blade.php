            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Edit Appreciation</h4>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title mb-0">Edit Appreciation</h4>
                        </div>
                        <div class="card-body">
                            <form id="createForm" method="POST" action="{{ route('admin.appreciations.update', $testimonial->id) }}" enctype="multipart/form-data" autocomplete="off">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            @if ($testimonial->image)
                                                <div class="image-preview" style="margin-top: 10px;">
                                                    <img src="{{ asset('storage/appreciations/' . $testimonial->image) }}" alt="Current Image" style="max-width: 100px; max-height: 100px; margin: 5px;">
                                                </div>
                                            @endif
                                ...
                                <div class="hstack gap-2 justify-content-end">
                                    ...
                                    <button type="submit" class="btn btn-success">Update Appreciation</button>
                                </div>
                            </form>
                        </div>
                    </div>
