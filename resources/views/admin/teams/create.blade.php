                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-header">
                            <h4 class="card-title mb-0">Add New Team Member</h4>
                        </div>
                            ...
                            <form method="POST" action="{{ route('admin.teams.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="url" name="instagram_link" class="form-control @error('instagram_link') is-invalid @enderror" value="{{ old('instagram_link') }}">
