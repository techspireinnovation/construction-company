                                        ...
                                        <table class="table table-nowrap table-centered align-middle">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="{{ asset('Backend/assets/images/users/avatar-1.jpg') }}" class="avatar-xxs rounded-circle me-1" alt="">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="{{ asset('Backend/assets/images/users/avatar-2.jpg') }}" class="avatar-xxs rounded-circle me-1" alt="">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="{{ asset('Backend/assets/images/users/avatar-3.jpg') }}" class="avatar-xxs rounded-circle me-1" alt="">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="{{ asset('Backend/assets/images/users/avatar-5.jpg') }}" class="avatar-xxs rounded-circle me-1" alt="">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="{{ asset('Backend/assets/images/users/avatar-6.jpg') }}" class="avatar-xxs rounded-circle me-1" alt="">
